  ...
  return (
    <div className="flex items-center justify-center w-auto">
      ...
      <button
        ...
        className="group relative inline-block py-1.5 px-1 w-6 h-6 bg-transparent hover:bg-[#ffffff1a] focus-visible:bg-[#ffffff1a] outline-none rounded-sm transition-colors duration-250"
      >
        ...
        <Tooltip
          text={toolbarIsOpen ? "Close toolbar menu" : "Open toolbar menu"}
        />
      </button>
    </div>
  );
